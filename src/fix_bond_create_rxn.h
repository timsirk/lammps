...
FixStyle(bond/create/rxn,FixBondCreateRxn)

#else

#ifndef LMP_FIX_BOND_CREATE_RXN_H
#define LMP_FIX_BOND_CREATE_RXN_H

#include "fix.h"

namespace LAMMPS_NS {

class FixBondCreateRxn : public Fix {
 public:
  FixBondCreateRxn(class LAMMPS *, int, char **);
  ~FixBondCreateRxn();
  int setmask();
  void init();
