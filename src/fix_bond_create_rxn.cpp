...
void FixBondCreateRxn::update_topology()
{
...
void FixBondCreateRxn::rebuild_special(int m)
{
...
void FixBondCreateRxn::create_angles(int m)
{
...
void FixBondCreateRxn::create_dihedrals(int m)
{
...
void FixBondCreateRxn::create_impropers(int m)
{
...
int FixBondCreateRxn::dedup(int nstart, int nstop, tagint *copy)
{
  int i;
